import { REDIS_ENTITY_METADATA_KEY } from '../core';
...
export function RedisEntity(parameters: RedisEntityDecoratorParameters): ClassDecorator {
  return function (target) {
    const decoratedFields = Reflect.getOwnMetadata(REDIS_ENTITY_METADATA_KEY, target) || new Map();
