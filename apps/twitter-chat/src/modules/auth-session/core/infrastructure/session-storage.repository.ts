...
import { SessionEntity } from '../../infrastructure/entities';

@Injectable()
export class SessionStorageRepository extends Repository<SessionEntity> implements SessionStorageInterface {
